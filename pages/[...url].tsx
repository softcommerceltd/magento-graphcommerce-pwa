...
import { CategoryHeroNav, CmsRowRenderer } from '@softcommerce/graphcommerce-magento-cms'
...
function CategoryPage(props: CategoryProps) {
  ...
  const cmsRowHeroBanner = category?.gc_asset
  ...
  return (
    <>
      <CategoryMeta
        ...
        metaRobots={category?.meta_robots?.toLowerCase().split('_') as MetaRobots[]}
        canonical={category?.url_path ? `/${category.url_path}` : undefined}
        {...category}
      />
      ...
      {isCategory && isLanding && (
        <CategoryHeroNav
          {...category}
          asset={cmsRowHeroBanner && <Asset asset={cmsRowHeroBanner} loading='eager' />}
      ...
      {category?.gc_metadata && (
        <CmsRowRenderer
          // @ts-ignore
          cmsRowContent={category.gc_metadata}
          renderer={{
