# GraphCommerce PWA Metapackage for Magento Open Source Extensions

Welcome to GraphCommerce PWA metapackage for Magento Open Source extensions.
As a metapackage for Magento Open Source, this repo enables developers to add any additional Magento Open Source features to Magento PWA modules.
...
1. Clone the `softcommerce-pwa` repository into your vendor directory name:
